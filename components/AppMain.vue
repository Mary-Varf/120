<template>
    <div class="xl:container m-auto md:py-6 py-0 sm:px-6 lg:px-8 bg-gray-100 text-black flex flex-col md:grid md:grid-cols-4 max-w-screen flex h-screen">
        <aside class="md:col-span-1 bg-gray-100 pr-2">
            <div class="pt-2 md:flex-col flex items-start justify-between bg-gray-100 md:max-w-[190px]">
                <AppAuth></AppAuth>
